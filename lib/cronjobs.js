                            ...
                            if(eachVendor.pp_price){
                                ...
                                mongodb.getVendorListing(query,function(err,lisitng){
                                    ...
                                    if(lisitng !== null){
                                        ...
                                        var request_img = lisitng.images[0]['request_list_url'];
                                        ...
                                        var params ={
                                            $set:{'notified_vendors.$.pp_price':eachVendor.pp_price,'notified_vendors.$.request_image':request_img,'notified_vendors.$.area':area,'stars':star_rating}
                                        }
...
var requestFormatting = crontab.scheduleJob("*/5 * * * *", requestFormatting);
