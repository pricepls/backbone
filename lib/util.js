...
var BASE_IMAGE_URL = "http://pricepls.imgix.net/";
...
var util = {
    ...
    uploadToS3: function (path, image, publicId, callback) {
        ...
        logger.debug("uploadToS3  bucket "+BUCKET_NAME);
    ...
    getModifiedImage:function(imgName,listing_number,w,h){

        var url = BASE_IMAGE_URL+listing_number+'/'+imgName+'?fit=crop&h='+h+'&w='+w;
        return url;
