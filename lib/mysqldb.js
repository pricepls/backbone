...
module.exports=function(){
    ...
    return {
        ...
        getAllSubtypesByCategory: function(category,callback){

            var query = "select id,name,category from subtypes where category = ? and status='active'";
            mysql_connect.query(query,[category],function(err,amenities){
        ...
        newCity : function (name,id,state_id,callback){
            ...
            mysql_connect.query(query,[name,id],function(err,city){
                ...
                if(err)
                    ...
                    mysql_connect.query('UPDATE cities SET modified_date=NOW() where id = ?',[city[0].id]);
        ...
        setCityUpdatedTime:function(cityid){
            mysql_connect.query('UPDATE cities SET modified_date=NOW() where name = ?',[cityid]);
        ...
        getNewnModifiedCities : function(diff,callback){

            var query = 'select id,name,country_id,state_id,status from cities where modified_date > NOW() - INTERVAL '+ diff+' MINUTE';
            console.log(query);
